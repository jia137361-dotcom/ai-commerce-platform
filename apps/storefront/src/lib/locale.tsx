...
const messages = {
  en: {
    ...
    navMe: "Me",
    navCart: "Cart",
    heroKicker: "Official store",
    heroTitleSuffix: "",
    heroDescription: "Shop published products with secure checkout and tracked delivery.",
    heroCtaStudio: "Shop now",
  ...
  zh: {
    ...
    heroKicker: "官方店铺",
    heroTitleSuffix: "",
    heroDescription: "浏览已发布商品，安全结账，配送可追踪。",
    heroCtaStudio: "立即购物",
    heroCtaShop: "浏览商品",
