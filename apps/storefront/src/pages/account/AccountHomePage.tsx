        ...
        <section className="buyer-account-layout">
          ...
          <div className="buyer-account-content">
            <Card as="section" className="buyer-account-overview">
              ...
              <h1>Welcome back</h1>
              <p>
                You are signed in as <strong>{auth.customer.email || "a buyer account"}</strong>. This
                cart is isolated to this buyer and store.
              </p>
            ...
            <Card as="section" variant="muted" className="buyer-account-session-card">
              ...
              <p>
                Switching accounts signs out this buyer session only. Seller dashboard access is not
                affected; each buyer sees only their own cart.
              </p>
              <div className="buyer-account-actions">
                <Button
                  variant="secondary"
                  onClick={() => void auth.signOut().then(() => window.location.assign("/account/sign-in"))}
                >
                  Switch account
                </Button>
                <Button
