...
const base = { cart: validCart, authLoading: false, authenticated: true, contactValid: true, requiresShippingMethod: false, addressValid: false, addressSaved: false, shippingMethodSaved: false, placingOrder: false }
