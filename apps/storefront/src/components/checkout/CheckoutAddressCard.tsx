...
type Props = { value: CheckoutAddress; onChange: (value: CheckoutAddress) => void; onSave: () => void; required: boolean; saving: boolean; saved: boolean; error?: string; savedAddresses?: BuyerCustomerAddress[]; selectedAddressId?: string; onSelectSavedAddress?: (address: BuyerCustomerAddress) => void; contact?: CheckoutContact; onContactChange?: (value: CheckoutContact) => void; onSaveContact?: () => void; contactStatus?: "idle" | "saving" | "saved" | "error"; contactError?: string }

export function CheckoutAddressCard({ value, onChange, onSave, required, saving, saved, error, savedAddresses = [], selectedAddressId, onSelectSavedAddress, contact, onContactChange, onSaveContact, contactStatus, contactError }: Props) {
