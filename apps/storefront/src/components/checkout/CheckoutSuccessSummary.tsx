...
export type CheckoutSuccessInfo = { orderId: string; displayId?: string; email?: string | null; total?: number; currencyCode?: string; paymentProviderId?: string; paymentStatus?: unknown }
  ...
  return (
    <Card as="section" className="buyer-checkout-success-card">
      ...
      <dl>
        ...
        <div><dt>Payment provider</dt><dd>{info.paymentProviderId ?? "Not provided"}</dd></div>
      </dl>
