...
const Product = model.define("mc_product", {
  ...
  s2b_basic_product_id: model.text().nullable(),
  s2b_material_id: model.text().nullable(),
  s2b_designed_product_id: model.text().nullable(),
  s2b_mockup_image_url: model.text().nullable(),
  s2b_size_id: model.text().nullable(),
  s2b_color_id: model.text().nullable(),
  s2b_view_id: model.text().nullable(),
  s2b_design_type: model.number().nullable(),
  supplier_product_status: model
    .enum([
      "not_created",
      "material_uploaded",
      "product_created",
    ...
    .default("not_created"),
  supplier_product_error: model.text().nullable(),
